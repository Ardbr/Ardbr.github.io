class MusicPlayer {
	constructor() {
		...
		this.musicList = ["/music/情诗几行-姜铭杨.mp3", "/music/云烟成雨 - 房东的猫.mp3", "/music/使一颗心免于哀伤 - HOYO-MiX,Chevy,知更鸟.mp3", "/music/单向箭头 - 双笙 (陈元汐).mp3"]
		this.coverList = ["/img/music_cover/情诗几行-cover.jpg", "/img/music_cover/云烟成雨-cover.webp", "/img/music_cover/使一颗心免于哀伤-cover.jpg", "/img/music_cover/单向箭头-cover.webp"]
		this.lyricList = ["/lyrics/情诗几行.lrc", "/lyrics/云烟成雨.lrc", "/lyrics/使一颗心免于哀伤.lrc", "/lyrics/单向箭头.lrc"]
